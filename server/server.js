...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", "data:", "https://maps.gstatic.com", "https://maps.googleapis.com", "https://ik.imagekit.io"],
...
app.put('/api/auth/profile', verifyToken, async (req, res) => {
  ...
  const { fullName, phone, dateOfBirth, gender, wishlist, cart, measurements } = req.body;
