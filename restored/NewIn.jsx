  ...
  return (
    <main className="w-full bg-white text-black text-[13px] font-sans">
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .category-item {
          d
                <svg viewBox="0 0 24 24" fill={wishlist.includes('newin-prod-8') ? '#1a1a1a' : 'none'} stroke={wishlist.includes('newin-prod-8') ? '#1a1a1a' : '#000'} strokeWidth="1.5">
            ...
            <Link to="/product/1" className="rec-card" style={{ display: 'block', textDecoration: 'none', color: 'inherit' }}>
              ...
              <div className="rec-info">
                ...
                <button className="wishlist-btn" onClick={(e) => { e.preventDefault(); toggleWishlist('newin-prod-9'); }}>
                <svg viewBox="0 0 24 24" fill={wishlist.includes('newin-prod-9') ? '#1a1a1a' : 'none'} stroke={wishlist.includes('newin-prod-9') ? '#1a1a1a' : '#000'} strokeWidth="1.5">
                  <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                </svg>
              </button>
              </div>
